...
# Reference         : CrossGradientAggregation
# Description       : another dl method
# ******************************************************
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data',type=str,default='Civil', choices=("CIFAR10", "CIFAR100", "MNIST"), help='Define the data used for training')
    ...
    tmp = model.state_dict()["fc2.weight"].numpy()
    print(tmp.shape, data_dim)
    dist.barrier()
    ...
    if rank == 0:
        hist = {"acc":trainer.global_testloader_acc_hist,"loss":trainer.global_trainloader_loss_hist,"cost_time":trainer.global_avg_train_time_hist}
        print("*" * 20)
        print("2. ",trainer.global_testloader_acc_hist)
        print("3. ",trainer.global_trainloader_loss_hist)
        print("4. ",trainer.global_avg_train_time_hist)
        print("*" * 20)
        print(hist)